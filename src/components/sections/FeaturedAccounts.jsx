      ...
      <div className="mmr-container">
        ...
        <div ref={ref} style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'flex-end', justifyContent: 'space-between', gap: '24px', marginBottom: '48px' }}>
          <div>
            ...
            >
              FEATURED<br />
              <span style={{ color: 'var(--accent)' }}>EQUIPMENT</span>
            </motion.h2>
          </div>
          <motion.p
            initial={{ opacity: 0 }}
          ...
          >
            Explore high-earning physical amusement cabinets. Engineered for long-term route stability, heavy tavern usage, and store promotions.
          </motion.p>
        </div>
