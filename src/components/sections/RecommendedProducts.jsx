...
export default function RecommendedProducts() {
  ...
  const displayProducts = products.filter(p => p.recommended && p.active).slice(0, 3);
      ...
      <div className="mmr-container">
        ...
        <div ref={ref} style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'flex-end', justifyContent: 'space-between', gap: '24px', marginBottom: '48px' }}>
          <div>
            ...
            >
              WE<br />
              <span style={{ color: 'var(--accent)' }}>RECOMMEND</span>
            </motion.h2>
          </div>
          <motion.p
            initial={{ opacity: 0 }}
          ...
          >
            Hand-picked selections from our experts. The best value and performance combinations available today.
          </motion.p>
        </div>
